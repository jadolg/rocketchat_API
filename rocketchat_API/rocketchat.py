...
class RocketChat:
    ...
    def users_setActiveStatus(self, user_id, user_status, **kwargs):
        """Update user status"""
        return self.__call_api_post("users.setActiveStatus", userId=user_id, activeStatus=user_status, **kwargs)
