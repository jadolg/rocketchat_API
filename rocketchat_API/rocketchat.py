...
class RocketChat:
    ...
    def groups_set_custom_fields(self, custom_fields, room_id=None, room_name=None, **kwargs):
        """Sets the custom fields for the private group."""
        if room_id:
            return self.__call_api_post('groups.setCustomFields', roomId=room_id, customFields=custom_fields,
                                        kwargs=kwargs)
        elif room_name:
            return self.__call_api_post('groups.setCustomFields', roomName=room_name, customFields=custom_fields,
                                        kwargs=kwargs)
        else:
            raise RocketMissingParamException('room_id or room_name required')
