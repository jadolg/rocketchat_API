...
def test_groups_add_and_remove_owner(logged_rocket, testuser_id, test_group_id):
    ...
    groups_add_owner = logged_rocket.groups_add_owner(test_group_id,
                                                    user_id=testuser_id).json()
    assert groups_add_owner.get('success'), groups_add_owner.get('error')

    groups_remove_owner = logged_rocket.groups_remove_owner(test_group_id,
                                                            user_id=testuser_id).json()
...
def test_groups_leave(logged_rocket, test_group_id, testuser_id):
    ...
    assert groups_leave.get('success') == False
...
def test_groups_set_type(logged_rocket, test_group_name, test_group_id):
    ...
    assert groups_set_type.get('success') == False
